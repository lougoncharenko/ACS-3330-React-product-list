...
// Challenge 4
const histogram = allCategories.reduce((obj, cat) => {
...
const namesAndCategories = categoriesUnique.map(category => ({
    category: category,
    count: histogram[category] || 0, // Access count from histogram or default to 0 if not found
  }));
  
  console.log(namesAndCategories);

  console.log("Categories Unique:", categoriesUnique);
console.log("Data:", data);
console.log("Histogram Keys:", Object.keys(histogram));

export {namesAndCategories, categoriesUnique}